...
const struct keycode_table_ent keycode_table[256] = {
	...
	[KEYD_EQUAL] = { "´", "grave", "`" }, //todo rename idx
	...
	[KEYD_R] = { "r", NULL, "R" },
	[KEYD_T] = { "t", NULL, "T" },
	[KEYD_Y] = { "z", NULL, "Z" },//todo rename idx
	[KEYD_U] = { "u", NULL, "U" },
	[KEYD_I] = { "i", NULL, "I" },
	[KEYD_O] = { "o", NULL, "O" },
	[KEYD_P] = { "p", NULL, "P" },
	...
	[KEYD_GRAVE] = { "#", "numbersign", "'" },//todo rename idx
	[KEYD_LEFTSHIFT] = { "leftshift", "", NULL },
	[KEYD_BACKSLASH] = { "<", "lt-gt", ">" },//todo rename idx
	[KEYD_Z] = { "y", NULL, "Y" },//todo rename idx
	[KEYD_X] = { "x", NULL, "X" },
	[KEYD_C] = { "c", NULL, "C" },
	[KEYD_V] = { "v", NULL, "V" },
	[KEYD_B] = { "b", NULL, "B" },
