...
const struct keycode_table_ent keycode_table[256] = {
	...
	[KEYD_9] = { "9", NULL, ")"},
	[KEYD_0] = { "0", NULL, "="},
	[KEYD_MINUS] = { "ß", "ssharp", "?" }, //todo rename idx
	[KEYD_EQUAL] = { "´", "acute", "`" }, //todo rename idx
	...
	[KEYD_R] = { "r", NULL, "R" },
	[KEYD_T] = { "t", NULL, "T" },
	[KEYD_Z] = { "z", NULL, "Z" },//todo rename idx
	[KEYD_U] = { "u", NULL, "U" },
	[KEYD_I] = { "i", NULL, "I" },
	[KEYD_O] = { "o", NULL, "O" },
	[KEYD_P] = { "p", NULL, "P" },
	[KEYD_LEFTBRACE] = { "ü", NULL, "Ü" },//todo rename idx
	[KEYD_RIGHTBRACE] = { "+", "plus", "*" },//todo rename idx
	...
	[KEYD_K] = { "k", NULL, "K" },
	[KEYD_L] = { "l", NULL, "L" },
	[KEYD_SEMICOLON] = { "ö", NULL, "Ö" },//todo rename idx
	[KEYD_APOSTROPHE] = { "ä", NULL, "Ä" },//todo rename idx
	[KEYD_GRAVE] = { "^", "hat", "°" },//todo rename idx
	[KEYD_LEFTSHIFT] = { "leftshift", "", NULL },
	[KEYD_BACKSLASH] = { "#", "numbersign", "'" },//todo rename idx
	[KEYD_Y] = { "y", NULL, "Y" },//todo rename idx
	[KEYD_X] = { "x", NULL, "X" },
	[KEYD_C] = { "c", NULL, "C" },
	[KEYD_V] = { "v", NULL, "V" },
	[KEYD_B] = { "b", NULL, "B" },
	[KEYD_N] = { "n", NULL, "N" },
	[KEYD_M] = { "m", NULL, "M" },
	[KEYD_COMMA] = { ",", "comma", ";" },//todo rename idx
	[KEYD_DOT] = { ".", "dot", ":" },//todo rename idx
	[KEYD_SLASH] = { "-", "minus", "_" },//todo rename idx
	...
	[KEYD_102ND] = { "<", "lt-gt", ">" },//todo rename idx
